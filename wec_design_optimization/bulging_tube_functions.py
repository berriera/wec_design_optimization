...
omega_range = np.linspace(0.1, 8.0, 40)
...
tube = cpt.HorizontalCylinder(
    ...
    nx=40, ntheta=15, nr=3, clever=False,
)
...
animation = tube.animate(motion={'Surge': 1.0, 'bulge_1': 0.10, 'bulge_2': 0.04 + 0.07j, 'bulge_3': -0.05 - 0.03j, 'bulge_4': -0.01-0.02j}, loop_duration=4.0)
animation.run()
